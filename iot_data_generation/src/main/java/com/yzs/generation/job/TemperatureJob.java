...
@Slf4j
public class TemperatureJob implements BaseJob {

    private final Random rand = new Random();
    private static final int MAX = DeviceValueConst.TEMP_MAX;
    private static final int MIN = DeviceValueConst.TEMP_MIN;
    ...
    public void execute(JobExecutionContext context) {
        ...
        log.info("TemperatureJob  执行: {}", message);
    }
