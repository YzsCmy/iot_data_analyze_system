...
<body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <select  class="form-control select2" style="width: 100%"
                                                     ...
                                                     id="unitSelect" data-placeholder="请选择单元">
                                            </select>
                                        </div>
                                    </div>
									<div class="col-md-3">
	...
	<script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/unit/select.do",
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
                        ...
                        $("#unitSelect").empty()
                        for(k in list){
                            $("#unitSelect").append('<option value="'+list[k].id+'">'+list[k].name+'</option>');
                        }
                        //初始化测点下拉框
                        var unitId = $("#unitSelect option:selected").val();
                        pointSelectInit(unitId)
