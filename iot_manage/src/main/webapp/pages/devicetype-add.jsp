...
<link rel="stylesheet"
	...
	<%--<div class="wrapper">--%>
		...
		<%--<div class="content-wrapper">--%>
			...
			<h1>
				设备类型管理 <small>设备类型表单</small>
			</h1>
			<ol class="breadcrumb">
				<li><a target="_parent" href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="${pageContext.request.contextPath}/deviceType/findAll.do">设备类型管理</a></li>
				<li class="active">设备类型表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form id="myform" action="${pageContext.request.contextPath}/deviceType/save.do"
				method="post"  onsubmit="return check()">
				<!-- 正文区域 -->
				<section class="content"> <!--产品信息-->

				<div class="panel panel-default">
					<div class="panel-heading">设备类型信息</div>
					<div class="row data-type" style="margin-left: 0px">

						<div class="col-md-2 title">设备类型名称</div>
            ...
            $("#myform").ajaxForm(function (data) {
                if(data.flag==true){
                    ...
                    $('#myModal').on('hide.bs.modal', function () {
                        // 执行一些动作...
                        location.href='${pageContext.request.contextPath}/deviceType/findAll.do';
                    })
