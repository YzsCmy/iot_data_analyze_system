...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/unit/user.do",
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/unit/device.do",
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
