...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/meas/measNum.do",
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/meas/measDataAllUnit.do",
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/meas/data.do",
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
                        var vo = data.data;
