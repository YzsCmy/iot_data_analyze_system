				...
				<div class="box box-primary">
							...
							<%--<div class="pull-left">--%>
								<%--<div class="form-group form-inline">--%>
									<%--<div class="btn-group">--%>
										...
										<%--<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/unit/addUnit.do'">--%>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc">实测值（${unit}）</th>
										<th class="sorting_desc">设备名称</th>
										<th class="sorting_desc sorting_desc_disabled">测点名称</th>
										<th class="sorting">单元名称</th>
										<th class="sorting">设备类型</th>
										<th class="sorting">产生时间</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="deviceData">
										<tr>
											<td><input name="selectck" type="checkbox" value="${deviceData.id}"></td>
											<td>${deviceData.id }</td>
											<td>${deviceData.value }</td>
											<td>${deviceData.name }</td>
											<td>${deviceData.pointName }</td>
											<td>${deviceData.unitName }</td>
											<td>${deviceData.typeName }</td>
											<td>${deviceData.createdTimeStr }</td>
											<%--<security:authorize access="hasRole('ROOT')">--%>
											<%--<td>${user.unitName }</td>--%>
											<%--</security:authorize>--%>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/deviceData/findAll.do?page=1&size=${pageInfo.pageSize}&deviceId=${deviceId}" aria-label="Previous">首页</a>
								</li>
								<li id="preitem"><a href="${pageContext.request.contextPath}/deviceData/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&deviceId=${deviceId}">上一页</a></li>
								<c:forEach begin="${pageInfo.pageNum-2<1?1:pageInfo.pageNum-2}" end="${pageInfo.pageNum+2>pageInfo.pages?pageInfo.pages:pageInfo.pageNum+2}"  var="pageNum">
									<li name="pageitem"><a href="${pageContext.request.contextPath}/deviceData/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}&deviceId=${deviceId}">${pageNum}</a></li>
								</c:forEach>
								<li id="nextitem"><a href="${pageContext.request.contextPath}/deviceData/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&deviceId=${deviceId}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/deviceData/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&deviceId=${deviceId}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
	...
	<script>
        ...
        function editUnit() {
            ...
            if(i==0){
                ...
                location.href='${pageContext.request.contextPath}/deviceData/edit.do?id='+id;
        ...
        function changePageSize() {
            ...
            //向服务器发送请求，改变没页显示条数
            location.href = "${pageContext.request.contextPath}/deviceData/findAll.do?page=1&size="
                + pageSize+"&deviceId=${deviceId}";
        }
