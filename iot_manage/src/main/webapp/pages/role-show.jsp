...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%--<div class="wrapper">--%>
		...
		<%--<div class="content-wrapper">--%>
			...
			<ol class="breadcrumb">
				<li><a target="_parent" href="${pageContext.request.contextPath}/index.jsp">
					<i class="fa fa-dashboard"></i> 首页</a></li>
				<li>
					<a href="${pageContext.request.contextPath}/role/findAll.do">角色管理</a></li>
					...
					<div class="table-box">
						...
						<div class="tab-pane" id="tab-treetable">
							<table id="collapse-table"
								...
								<tbody>
									<c:forEach items="${role.permissions}" var="per" varStatus="vs">
