...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/device/deviceInUnit.do",
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/device/deviceDataInUnit.do",
                data: {unitId:'${sessionScope.unitId}'},
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/chart/device/data.do",
                data: {unitId:'${sessionScope.unitId}'},
                success: function(data){
                    if(data.flag==true){
                        console.log(data.data)
