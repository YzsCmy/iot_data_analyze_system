...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%--<div class="wrapper">--%>
		...
		<%--<div class="content-wrapper">--%>
			...
			<h1>
				单元管理 <small>全部单元</small>
			</h1>
			<ol class="breadcrumb">
				<li><a target="_parent" href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/unit/findAll.do">单元管理</a></li>

				<li class="active">全部单元</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">单元名称</th>
										<th class="sorting_desc sorting_desc_disabled">地址</th>
										<th class="sorting">单元管理员</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="unit">
										<tr>
											<td><input name="selectck" type="checkbox" value="${unit.id}"></td>
											<td>${unit.id }</td>
											<td>${unit.name }</td>
											<td>${unit.address }</td>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/unit/findAll.do?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
								<li id="preitem"><a href="${pageContext.request.contextPath}/unit/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="${pageInfo.pageNum-2<1?1:pageInfo.pageNum-2}" end="${pageInfo.pageNum+2>pageInfo.pages?pageInfo.pages:pageInfo.pageNum+2}"  var="pageNum">
									<li name="pageitem"><a href="${pageContext.request.contextPath}/unit/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								<li id="nextitem"><a href="${pageContext.request.contextPath}/unit/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/unit/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
	...
	<script>
        ...
        function editUnit() {
            ...
            if(i==0){
                ...
                location.href='${pageContext.request.contextPath}/unit/edit.do?id='+id;
        ...
        function changePageSize() {
            ...
            //向服务器发送请求，改变没页显示条数
            location.href = "${pageContext.request.contextPath}/unit/findAll.do?page=1&size="
                + pageSize;
        }
